...
@pytest.mark.parametrize("pair_number,expected_major_color,expected_minor_color",
...
@pytest.mark.parametrize("major_color,minor_color,expected_pair_number",
                         [('Black', 'Orange', 12), ('Violet', 'Slate', 25),
                          ('Red', 'Orange', 7)])
